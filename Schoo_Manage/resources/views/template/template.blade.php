...
<title>โรงเรียนไทยรัฐวิทยา ๖๘ (วัดเหวลาด)</title>
<!-- Favicon-->
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img src="assets/images/logo.png" width="48" height="48" alt="Alpino"></div>
        <p>กรุณารอสักครู่...</p>        
    </div>
</div>
    ...
    <ul class="nav navbar-nav">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><img src="assets/images/logo.png" width="35" alt="Alpino"><span class="m-l-10">Smart TR68</span></a>
            </div>
        </li>
        <li class="search_bar">
        ...
        <div class="row">
            <div class="col-md-12">                
                <ul class="h-menu">
                    ...
                    <li class="open active"><a href="javascript:void(0)">Pages</a>
